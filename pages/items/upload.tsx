...
const Upload: NextPage = () => {
    return (
        <div className={"px-4 space-y-5 py-10"}>
            ...
            <button className={"bg-emerald-500 hover:bg-emerald-600 text-white py-2 px-4 border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 focus:outline-none w-full"}>업로드</button>
        </div>
    );
};
