           ...
           <div className={"mb-8"}>
               ...
               <div className={"flex py-3 border-t border-b items-center space-x-3"}>
                   ...
                   <div>
                       ...
                       <p className={"text-xs cursor-pointer font-medium text-gray-500"}>View profile &rarr;</p>
                   </div>
               </div>
               ...
               <div className={"mt-5"}>
                   ...
                   <div className={"flex items-center justify-between space-x-2"}>
                       <button className={"flex-1 bg-emerald-600 text-white py-3 rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 hover:bg-emerald-700"}>판매자와 대화하기</button>
