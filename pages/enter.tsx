        ...
        <div className={"mt-16 px-4"}>
            ...
            <div className={"mt-8"}>
                ...
                <form className={"flex flex-col mt-8"}>
                    ...
                    <button className={"bg-emerald-500 hover:bg-emerald-600 text-white py-2 px-4 border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 focus:outline-none mt-5"}>
                ...
                <div className={"mt-10"}>
                    <div className={"relative"}>
                        ...
                        <div className={"relative -top-3 text-center"}>
                            <span className={"bg-white px-2 text-sm text-gray-500"}>다른 로그인 방법</span>
                        </div>
                    </div>
                    <div className={"grid grid-cols-2 mt-3 gap-3"}>
                        <button className={"flex justify-center px-4 py-2 border border-gray-300 shadow-sm rounded-md text-sm font-medium text-gray-500 hover:bg-gray-50"}>
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
                                fill="currentColor"
