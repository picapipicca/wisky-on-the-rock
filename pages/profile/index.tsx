            ...
            <div className="px-4">
                <div className={"flex items-center space-x-4"}>
                    ...
                    <div className={"flex flex-col"}>
                        <span className={"font-medium text-gray-900"}>이방구</span>
                        <span className={"text-sm text-gray-700 "}>Edit profile &rarr;</span>
                    </div>
                </div>
                <div className={"flex mt-10 justify-around"}>
                    <div className={"flex flex-col items-center"}>
                        <div className={"w-14 h-14 text-white bg-emerald-600 rounded-full flex items-center justify-center"}>
                            <svg
                                className="w-6 h-6"
                                fill="none"
                                stroke="currentColor"
                ...
                <div className={"mt-12"}>
                    <div className={"flex space-x-4 items-center"}>
                        ...
                        <div>
                            <h4 className={"text-sm font-bold text-gray-800"}>윤방구</h4>
